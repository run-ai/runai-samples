...
This script can be run on a schedule to export GPU utilization per project to a CSV file using metrics from the [Run:AI Metrics API](https://docs.run.ai/v2.13/developer/metrics/metrics/)

The only two variables needed to be configured are the URL of your Run:ai instance and a grafana API key.
